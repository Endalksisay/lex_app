...
public class User
{
    ...
    private void createUserTokens()
    {
        Token mcdonalds = new Token("MC123", "Mcdonalds",
                "McDonald's variety token.", R.drawable.mcdonalds, 15.50);
        ...
        Token vans = new Token("VASSC", "Vans",
                "Skate or die with Vans.", R.drawable.vans, 1.32);
        ...
        Token bestbuy = new Token("BB", "Best Buy",
                "Best Buy Bucks buys more than bucks.", R.drawable.bestbuy, .53);
        Token target = new Token("T4RG", "Target",
                "Target your daily needs with TarTokens.", R.drawable.target, 2.33);
        ...
        Token amazon = new Token("4M421NG", "Amazon",
                "Amazon amazonian currency.", R.drawable.amazon, 123.22);
